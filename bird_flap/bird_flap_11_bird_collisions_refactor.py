        ...
        if len(self.bird_list) == 1:
            ...
            while b < bird_count:
                ...
                for other_bird in other_birds:
                    ...
                    if bird.hits_from_above(other_bird.x,other_bird.y,other_bird.w,other_bird.h):
                        ...
                        if bird.velocity_y == -1:
                            ...
                            other_bird.velocity_y = 1
                        if other_bird.velocity_y == -1:
                            other_bird.velocity_y = 0
                        if other_bird.velocity_y == 
                        bird.velocity_y = -1
                    ...
                    if other_bird.is_same_bird:

                    else:
                        bird_collision = bird.intersects(other_bird.x,other_bird.y,other_bird.w,other_bird.h)
                        edge_collision = bird.reached_screen_edge(self.screen_x,self.screen_y)
                        if bird_collision and edge_collision:
                            # step bird away from edge
                            print("step away")
                            if bird.x <= 0: 
                                bird.x = 0
                                bird.velocity_x = 1
                            if bird.x >= self.screen_x: 
                                bird.x == self.screen_x
                                bird.velocity_x = -1
                            if bird.y <= 0:
                                bird.y = 0
                                bird.velocity_y = 1
                            if bird.y >= self.screen_y: 
                                bird.y = self.screen_y
                                bird.velocity_y = 1

                        if bird_collision and not edge_collision:
                        ...
                        if not bird_collision and edge_collision:
                            # bird.bounce_off_edge(self.screen_x,self.screen_y)
                            if bird.x <= 0: 
                                bird.x = 0
                                bird.velocity_x = 1
                        ...
                        if not bird_collision and not edge_collision:
                            pass
